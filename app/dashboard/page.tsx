    ...
    <main className="mx-auto min-h-screen max-w-7xl p-6">
      <header className="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
        <div>
          ...
          <p className="text-sm text-slate-600">Free-source odds ingest with weighted blend fair pricing.</p>
          <p
            className="text-xs text-slate-500"
            title="True Odds: Weighted Blend (Pin/Circa/CRIS/DK/FD/MGM)"
          >
            True Odds: Weighted Blend (Pin/Circa/CRIS/DK/FD/MGM)
          </p>
        </div>
